// Professional Website JavaScript - Complete Fix
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Theme system preferences:', window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light');
...
// Example usage for adding videos:
...
function enhancedMobileNavigation() {
    const navbar = document.querySelector('.navbar');
    let lastScrollTop = 0;
